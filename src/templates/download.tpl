          ...
          <div class="container">
            ...
            <div clas="row">
              ...
              <div class="col-md-6 column">
                ...
                <div>
                  ...
                  -->
                  <a href="http://docs.domogik.org/domoweb/">
                    <i class="fa fa-book"></i> Documentation
                  </a>
                </div>
              </div>
            ...
            <div clas="row">
              <div class="col-md-6 column">
                <h2>DomoButler</h2>
                <p>
                  Domogik butler est l'application Android qui vous permet de parler avec Domogik.
                </p>
                <div>
                  <a href="https://github.com/Cereal2nd/DomoButler/releases/download/0.4/DomoButler-0.4.apk">
                    <i class="fa fa-download"></i> Télécharger
                  </a>&nbsp;
                  <!--
                  <a href="">
              ...
              <div class="col-md-6 column">
                <h2>Domodroid</h2>
                <p>
                  Domodroid est l'application Android compatible avec Domogik. Elle vous permet de contrôler votre maison depuis une tablette ou votre smartphone.
                </p>
                <p><em>Attention, l'application est encore en cours de développment. Elle peut contenir des bugs</em></p>
                <div>
                  <a href="https://play.google.com/store/apps/details?id=org.domogik.domodroid13&hl=fr">
                    <i class="fa fa-download"></i> Télécharger
                  </a>&nbsp;
                  <!--
                  <a href="">
                  ...
                  -->
                  <a href="http://domodroid.readthedocs.org">
                    <i class="fa fa-book"></i> Documentation
                  </a>
                </div>
              </div>
